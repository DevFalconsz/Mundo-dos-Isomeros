...
const createGame = canvas => {
  ...
  const start = () => {
    ...
    const roullete = createRoullete([
      {text: "10", color: "#600"}, {text: "15", color: "#000"},
      {text: "20", color: "#600"}, {text: "25", color: "#000"},
      {text: "30", color: "#600"}, {text: "35", color: "#000"},
      {text: "40", color: "#600"}, {text: "45", color: "#000"},
      {text: "50", color: "#600"}, {text: "55", color: "#000"},
      {text: "60", color: "#600"}, {text: "65", color: "#000"},
    ], ctx)
